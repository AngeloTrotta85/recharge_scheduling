	...
	for ci in $CONFIGS_INI; do
		...
		if [ "$ci_name" = "$cu" ]; then 
			...
			do
				...
				COMM="../../src/recharge_scheduling -r ${IDX} -u Cmdenv -c ${ci_name} -n ../../src:..:../../../../Programs/omnetpp-5.0/samples/inet/examples:../../../../Programs/omnetpp-5.0/samples/inet/src:../../../../Programs/omnetpp-5.0/samples/inet/tutorials:../../../inet_ext/src:../../../inet_ext/simulations:../../../virtual_spring/examples:../../../virtual_spring/src -l ../../../../Programs/omnetpp-5.0/samples/inet/src/INET -l ../../../inet_ext/src/inet_ext -l ../../../virtual_spring/src/virtual-spring --debug-on-errors=false omnetpp.ini"
