...
do
	...
	#./launch_test_serv.sh ${i} ${NPARALLEL} "TestFullNumUavTauDistrGAMETHEORY_SERV TestFullH5CentrNORECHARGE_SERV TestFullH5CentrANALYTICAL_SERV TestFullH5DistrPROBABILISTIC_SERV TestFullH5DistrGAMETHEORY_SERV TestFullBeaconingEnergyNewCentrNORECHARGE_SERV TestFullBeaconingEnergyNewCentrANALYTICAL_SERV TestFullBeaconingEnergyNewDistrPROBABILISTIC_SERV TestFullBeaconingEnergyNewDistrGAMETHEORY_SERV TestFullBeaconingPositionNewCentrNORECHARGE_SERV TestFullBeaconingPositionNewCentrANALYTICAL_SERV TestFullBeaconingPositionNewDistrPROBABILISTIC_SERV TestFullBeaconingPositionNewDistrGAMETHEORY_SERV TestFullAlphaBetaNewCentrNORECHARGE_SERV TestFullAlphaBetaNewCentrANALYTICAL_SERV TestFullAlphaBetaNewDistrPROBABILISTIC_SERV TestFullAlphaBetaNewDistrGAMETHEORY_SERV" /home/angelo/git/recharge_scheduling/simulations/test/logs/TestFullNewLogs &
	./launch_test_serv.sh ${i} ${NPARALLEL} "TestFullGammaDeltaCentrANALYTICAL_Shift_SERV TestFullGammaDeltaCentrNORECHARGE_Shift_SERV TestFullGammaDeltaDistrPROBABILISTIC_Shift_SERV TestFullGammaDeltaDistrGAMETHEORY_Shift_SERV" /home/angelo/git/recharge_scheduling/simulations/test/logs/TestFullNewLogs &
